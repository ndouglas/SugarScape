...
- **Deaths:** borrower dies → loan cancelled (lender's loss). Lender dies → loan cancelled, unless inheritance (I) is on, in which case the claim is split equally among the lender's living children (one new loan per child, same due tick).
