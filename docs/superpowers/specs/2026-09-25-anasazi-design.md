...
- **Honesty:** presets, README and descriptions say this reproduces Janssen's 2009 replication (itself an approximation of Axtell et al. 2002, A-20), which behaviours come from the replication rather than the written description, and how close each preset gets to the historical record as measured.
